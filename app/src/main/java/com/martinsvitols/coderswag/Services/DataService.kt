package com.martinsvitols.coderswag.Services
...
object DataService {
    ...
    val hoodies = listOf(
            Product("Devsolpes Hoodies Gray", "$28", "hoodie1"),
            Product("Devslopes Hoodies Red", "$32", "hoodie2"),
            Product("Devslopes Gray Hoodie", "$28", "hoodie3"),
            Product("Devslopes Black Hoodies ", "$28", "hoodie4"),
            Product("Devsolpes Hoodies Gray", "$28", "hoodie1"),
            Product("Devslopes Hoodies Red", "$32", "hoodie2"),
            Product("Devslopes Gray Hoodie", "$28", "hoodie3"),
            Product("Devslopes Black Hoodies ", "$28", "hoodie4"),
    ...
    val shirts = listOf(
            Product("Devsolpes Shirt Black", "$18", "shirt1"),
